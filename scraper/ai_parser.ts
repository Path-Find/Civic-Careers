...
export interface ParsedJob {
    ...
    security_check_required: boolean | null;
...
export async function parseJobWithAI(description: string, titleHint?: string): Promise<ParseResult> {
    ...
    SCHEMA:
    {
      ...
      "certification_requirements": "Required non-licence certifications or training, such as First Aid/CPR, WHMIS, Food Handler, or health and safety certificates. Do not include optional assets. Empty array if none are required.",
      "software_requirements": "Named software, applications, or platforms required by the posting, such as Microsoft Office, Excel, Adobe Acrobat, AutoCAD, ArcGIS, HEC-RAS, SAP, Power BI, Tableau, ACL, IDEA, Brightspace, or Windows. Only include an actual named product or platform; do not include ambiguous categories such as 'engineering design software', 'computer software', or 'office environment'. Normalize Microsoft Office, Microsoft Office Suite, Microsoft Suite, MS Office, MS Office Suite, and Office 365 to the canonical value 'Microsoft Office'; normalize Microsoft 365 and M365 to 'Microsoft 365'; normalize Microsoft Word/MS Word to 'Word', Microsoft Excel/MS Excel to 'Excel', Microsoft PowerPoint/MS PowerPoint to 'PowerPoint', Microsoft Outlook/MS Outlook to 'Outlook', Microsoft Access/MS Access to 'Access', Microsoft Visio/MS Visio to 'Visio', and Microsoft Project/MS Project to 'Project'. Normalize Adobe Acrobat, Adobe Acrobat Pro, Adobe Pro, and Acrobat Pro to 'Adobe Acrobat'; keep Adobe Creative Cloud as 'Adobe Creative Cloud'; normalize Adobe Photoshop/Photoshop to 'Photoshop', Adobe Illustrator/Illustrator to 'Illustrator', Adobe InDesign/InDesign to 'InDesign', and Adobe Captivate/Captivate to 'Adobe Captivate'. Keep individual products separate when the posting names them. Do not include generic computer literacy or a mention of software in a duty unless the posting makes it a candidate requirement. Empty array if none are stated.",
      "medical_requirements": "Named medical or physical fitness standards required to hold the role, such as a vision/hearing test, physical fitness test, or medical assessment tied to a specific standard (e.g. 'Normal color vision or Snellen visual acuity confirmation', 'PARE physical fitness test'). Do not include a generic pre-employment medical exam mention with no named standard, and do not duplicate security_check_required content here. Empty array if none are stated.",
