...
| `duration` | Canonical value: `Permanent`, `Ongoing`, `Seasonal`, `Term`, `N months`, `N years`, `Up to N months`, `N-month work year`, an academic term, or `YYYY-MM-DD to YYYY-MM-DD` | Contract/assignment length or date range; do not use for application closing dates |
