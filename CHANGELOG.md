...
### Fixed
- **Recurring source boilerplate could remain in job descriptions**: confirmed Metrolinx, Government of Canada, Brock University, City of Brantford, and University of Waterloo employer/application blocks are now removed deterministically while role-specific requirements and eligibility remain intact.
