...
- City of Abbotsford — https://www.abbotsford.ca/city-hall/human-resources/career-opportunities (Njoyn; 8 jobs stored in manual run 30725466168; staged in the Trial Action)
...
- Town of Newmarket — https://sire.newmarket.ca/TownGovernment/Pages/Job-Opportunities.aspx (main and recreation postings use HRSmart at https://newmarket.hua.hrsmart.com/hr/ats/JobSearch/viewAll; 14 jobs stored in manual run 30725902033; staged in the Trial Action)
...
- County of Brant — https://countyofbrant.applytojob.com/apply/ (JazzHR/ApplyToJob; 4 postings stored successfully in manual run 30724286120; staged in the Trial Action)
- County of Wellington — https://careers.wellington.ca/ (Jobs2Web; 8 jobs stored in manual batch `manual-ready-5`; staged in the Trial Action)
- Essex County — https://www.countyofessex.ca/county-government/careers-and-volunteering/career-opportunities/ (JazzHR; 6 jobs stored in manual batch `manual-ready-5`; staged in the Trial Action)
...
- Lambton County — https://recruiting.ultipro.ca/COR5004CLMB/JobBoard/6b014206-1003-40c3-98a0-b2340f1971da/?o=postedDateDesc&q= (UltiPro; 15 jobs stored in manual run 30724917303; staged in the Trial Action)
- Grey County — https://jobs.dayforcehcm.com/en-CA/greycounty/CANDIDATEPORTAL (Dayforce; 5 jobs stored in manual batch `manual-ready-5`; staged in the Trial Action)
...
- City of Quinte West — https://canr58.dayforcehcm.com/CandidatePortal/en-CA/quintewest (Dayforce; 4 jobs stored in manual batch `manual-ready-5`; staged in the Trial Action)
...
- Loyalist College — https://gjobs.neogov.ca/careers/loyalistcollege (NEOGOV; 22 jobs stored in manual batch `manual-ready-5`; staged in the Trial Action; shared engine tracked in issue #74)
...
- LCBO — https://www.lcbo.com/content/lcbo/en/corporate-pages/careers/job-paths.html (Workday; 18 jobs stored in manual run 30725034212; staged in the Trial Action)
- OLG — https://about.olg.ca/working-with-us/olg-careers/ (Workday; 7 jobs stored in manual run 30725034212; staged in the Trial Action)
- WSIB — https://www.wsib.ca/en/careers (Oracle Cloud; 2 jobs stored in manual run 30725034212; staged in the Trial Action)
- Ontario Health — https://oh.wd3.myworkdayjobs.com/en-US/OH (Workday; validated in the Workday manual batch)
- Public Health Ontario — https://www.publichealthontario.ca/en/about/careers/current-job-opportunities (Workday; 3 jobs stored in manual run 30725034212; staged in the Trial Action)
- Ontario Health atHome — https://www.ontariohealthathome.ca/careers/ (iCIMS; 61 jobs stored in manual run 30725034212; staged in the Trial Action)
